import { c as createLucideIcon, m as commonjsGlobal, n as getDefaultExportFromCjs, r as reactExports, o as clsx, R as React, p as invariant, j as jsxRuntimeExports, C as ChartNoAxesColumn, g as Skeleton } from "./index-93qgKiy3.js";
...
const PieTooltip = ({
  ...
  if (active && payload && payload.length > 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-card text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: payload[0].name }),
...
function AnalyticsPage() {
  ...
  const pieData = reactExports.useMemo(
    () => CATEGORIES.map((cat) => ({
      ...
      value: notices.filter((n2) => n2.category === cat).length,
      category: cat
  ...
  const lineData = reactExports.useMemo(() => {
    ...
    for (const notice of notices) {
      ...
      const d2 = new Date(ts > 1e12 ? ts : ts * 1e3);
      const dateStr = d2.toISOString().split("T")[0];
  ...
  const lineTicks = reactExports.useMemo(
    () => lineData.filter((_, i) => i % 5 === 0 || i === lineData.length - 1).map((d2) => d2.label),
    [lineData]
  );
  const totalNotices = notices.length;
  const activeCategories = pieData.length;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6 animate-fade-in", "data-ocid": "analytics.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "space-y-1",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground", children: "Analytics Overview" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Visual breakdown of campus notices and activity" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-4 py-2.5 flex items-center gap-2 shadow-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gradient-primary p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-5 w-5 text-primary-foreground/90" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-primary-foreground text-sm", children: "Notice Distribution by Category" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-xs mt-0.5", children: "Breakdown of all posted notices" })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
              loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 w-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-40 w-40 rounded-full mx-auto" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-48 mx-auto" })
              ] }) }) : pieData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  "data-ocid": "analytics.pie_chart.empty_state",
                  className: "flex flex-col items-center justify-center h-64 text-muted-foreground",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-10 w-10 mb-2 opacity-40" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No data available yet" })
                  ]
                }
              ...
              !loading && pieData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 grid grid-cols-2 gap-2 pt-3 border-t border-border", children: pieData.map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-center justify-between text-xs px-2 py-1.5 rounded-lg bg-muted/50",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: d2.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: d2.value })
                  ]
                },
                d2.category
              )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gradient-primary p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-5 w-5 text-primary-foreground/90" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-primary-foreground text-sm", children: "Notices Posted Over Time" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-xs mt-0.5", children: "Daily activity for the last 30 days" })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 h-64 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-full w-full rounded-lg" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              LineChart,
              {
                data: lineData,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(LineTooltip, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Legend,
                    {
                      formatter: () => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-foreground", children: "Notices Posted" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Line,
